"""
Django settings for codevimarsh project.
"""
...
WSGI_APPLICATION = 'codevimarsh.wsgi.application'
...
# Session Configuration (Session-based Authentication)
